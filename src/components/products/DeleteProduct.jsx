...
const DeleteProduct = ({ openModal, setOpenModal, product }) => {
    let { name, small_img, id } = product[0]
    ...
    return (
        ...
        >
            ...
            <Box style={style} sx={{ display: 'flex', alignItems: 'center', pl: 1, pb: 1, backgroundColor: theme.palette.background.alt }} >
                <CardMedia
                    component="img"
                    sx={{ width: 151, borderRadius:'1rem' }}
                    image={small_img}
                    alt={name}
                />
                ...
                <CardActions sx={{}} >
                    ...
                    >
                        <BottomNavigationAction label="Yes" icon={<CheckOutlinedIcon />} />
                        <BottomNavigationAction label="No" icon={<ClearOutlinedIcon />} />
                    </BottomNavigation>
                </CardActions>
            </Box>    
        </Modal>
